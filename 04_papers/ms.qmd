...
dev_change_plot <- ggplot(fixed_only, aes(age, metric_value)) +
...
ef_firstrun_scores <- included_scores |>
  ...
  arrange(user_id, item_task, run_number, age) |>
  group_by(user_id, item_task) |>
  slice(1) |>
  ungroup()

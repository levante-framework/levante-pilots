...
```{r}
#| label: fig-tasks
#| fig-cap: "Screenshots from each of the nine LEVANTE core tasks. Top row: Sentence Understanding, Vocabulary, Hearts and Flowers; middle row: Memory Game, Same and Different Selection, Math; bottom row: Pattern Matching, Mental Rotation; Stories." 

task_fig <- png::readPNG(here("04_paper","display","tasks.png"))
grid::grid.raster(task_fig)

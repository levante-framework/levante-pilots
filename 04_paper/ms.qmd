...
name_map <- tibble::tibble(
  ...
  pretty = c("Age (log years)","Math","Stories","Reasoning","Executive Function","Language",
             "Pattern Matching","Shape Rotation","Hearts & Flowers","Memory","Same & Different",

...
![Screenshots from each of the nine LEVANTE core tasks. Top row, from left to right: Sentence Understanding, Vocabulary, Hearts and Flowers; middle row: Memory, Same and Different, Math; bottom row: Pattern Matching, Mental Rotation; Stories.](display/tasks_updated.svg){#fig-tasks}
...
ggplot(cat_only, aes(age, metric_value)) +
  ...
  labs(x = "Age (years)", y = "Ability (IRT score)", colour = "Site",
       title = "Ability vs Age (Adaptive only)") +
  theme(legend.position = "bottom")

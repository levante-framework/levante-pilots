...
fit_g_age <- sem(model_g_age, data = vars_core_std,
                 estimator = "MLR", std.lv = TRUE, missing = "fiml")
g <- summary(fit_g_age, fit.measures = TRUE, standardized = TRUE)

...
vocab_for_plot <- vocab_runs |>
  mutate(
    metric_value = correct,
    task_label = "Vocabulary",
    task_category = "Language" # to check
  )

threshold_n <- 50  # to check
task_plot_comparative(vocab_for_plot, ylab = "Proportion correct")

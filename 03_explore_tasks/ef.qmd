...
sds_disambig |> filter(item_group!="dimensions", item_group!="same") |>
...
sds_rescored |> select(user_id, timestamp, item_group, item, response, correct, trial_correct) |> 
  arrange(timestamp) |>
  View()

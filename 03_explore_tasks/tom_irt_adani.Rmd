...
tom_data_long %>%
  ...
  summarise(correct = round(mean(correct, na.rm = T),2), 
...
mod_coefs_1pl_configural =
  coef(mod_rasch_configural, simplify = F)
...
mod_coefs_2pl_configural =
  coef(mod_2pl_configural, simplify = F)

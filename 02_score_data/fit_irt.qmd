...
write_rds(task_data_prepped, here("02_scoring_outputs/irt_data/task_data_prepped.rds"),
          compress = "gz")
```
...
task_data_args <- task_data_prepped |>
  ...
  mutate(model_str = pmap_chr(list(data, data_prepped, item_type, model_type),
                              generate_model_str))
write_rds(task_data_args, here("02_scoring_outputs/irt_data/task_data_args.rds"),
          compress = "gz")
```
...
# save scores
write_rds(task_scores, here("02_scored_data/scores/scores_irt.rds"),
          compress = "gz")
```

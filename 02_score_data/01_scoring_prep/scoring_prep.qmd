...
trial_data_coded <- trial_data |>
  ...
  recode_hf() |>
  recode_sds() |>
  recode_wrong_items(wrong_items = item_fixes) |>
...
exclusions <- redivis$organization("levante")$dataset("item_metadata:czjv")$table("exclusions:0b5t")$to_tibble()
...
trial_data_subset <- trial_data_included |>

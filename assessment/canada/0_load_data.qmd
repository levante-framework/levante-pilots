...
# https://github.com/levante-framework/rlevante
source("scripts/_setup.R")
source("scripts/_data_loading_functions.R")
```

```{r datasets}
dataset_names <- c("CA-pilot")

dataset_tables <- get_datasets(dataset_names)


#dataset_tables$`CA-pilot`[["validation_results"]] <- NULL 
# validation_results is just a tibble with msg: "All data are valid." (at the moment, at least)
#dataset_tables$`CA-pilot`[["groups"]] <- NULL 

student_surveys <- dataset_tables$`CA-pilot`[["student_survey_responses"]] 
#dataset_tables$`CA-pilot`[["student_survey_responses"]] <- NULL # ToDo: figure out how to parse & save surveys

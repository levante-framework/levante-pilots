...
```{r}
# runs <- read_rds(here("00_prepped_data/us_pilot/runs.rds")) |> select(run_id, completed)
# scores_us <- task_scores |> filter(site == "us_pilot") |> left_join(runs)
# task_plot_completeness(scores_us, ylab = "Score", nr = 1)
# ggsave(here("03_summaries/plots/scores_us.png"), width = 12, height = 3.75)
```
